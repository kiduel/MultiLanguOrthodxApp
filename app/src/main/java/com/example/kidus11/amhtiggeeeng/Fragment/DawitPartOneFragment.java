...
public class DawitPartOneFragment extends Fragment {
    ...
    @BindView(R.id.eng_text_daw_1)
    TextView mez_dawit_part_one_eng_tv;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if (language == AMHARIC || language == TIGRIGNA || language == GEEZ){
            mez_dawit_part_one_tv.setText(Html.fromHtml(prayer));
        } else mez_dawit_part_one_tv.setText(prayer);
    ...
    private void makePrayerEnglish(){
        mez_dawit_part_one_tv.setVisibility(View.INVISIBLE);
        mez_dawit_part_one_eng_tv.setVisibility(View.VISIBLE);
        mez_dawit_part_one_eng_tv.setText(Html.fromHtml(prayer));
    }

    private void makePrayerNotEnglish(){
        mez_dawit_part_one_tv.setVisibility(View.VISIBLE);
        mez_dawit_part_one_eng_tv.setVisibility(View.INVISIBLE);
    }
}
